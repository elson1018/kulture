...
public class ProductServlet extends HttpServlet{ //Product Servlet
     ...
     * Returns the path to be stored in MongoDB (e.g., "/products/Instruments/image.jpg")
     */
    private String saveImageToFileSystem(String base64Image, String category, String originalFileName) throws IOException {
        ...
        // Structure: kulture/backend/MappingServlets -> kulture/frontend/public/products/{category}
        ...
        // Return path in format that matches existing products: "/products/{category}/{filename}"
